      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <StaggerGroup className="grid gap-6 md:grid-cols-3">
          ...
          <motion.div variants={staggerItem}>
            <a
              href="/callcatch"
              className="group relative rounded-2xl border border-cream-200 bg-white p-8 shadow-warm transition-all duration-300 hover:shadow-warm-lg hover:-translate-y-1 block"
            >
              {/* Live badge */}
