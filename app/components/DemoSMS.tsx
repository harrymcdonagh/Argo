...
export default function DemoSMS() {
  return (
    <section id="demo" className="relative bg-navy-800 py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto mb-14 max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-slate-text">
            Here&apos;s a real example of what happens when someone calls
            Essex PlumbPro and nobody picks up. The AI handles everything.
          </p>
        </div>

        {/* Phone mockup */}
        <div className="mx-auto max-w-sm">
          <div className="glow-blue rounded-[2.5rem] border border-white/10 bg-navy-900 p-2 shadow-2xl">
            {/* Phone notch */}
            <div className="relative rounded-[2rem] bg-navy-950 pb-6">
              {/* Status bar */}
              <div className="flex items-center justify-between px-8 pt-4 pb-3">
                <span className="text-xs font-medium text-white/60">14:32</span>
                <div className="mx-auto h-5 w-20 rounded-full bg-navy-900" />
                <div className="flex items-center gap-1">
                  ...
                  <svg className="ml-1 h-3 w-3 text-white/60" fill="currentColor" viewBox="0 0 20 20">
              ...
              {/* Chat header */}
              <div className="flex items-center gap-3 border-b border-white/5 px-5 pb-3">
                <div className="flex h-9 w-9 items-center justify-center rounded-full bg-electric-500 text-xs font-bold text-white">
                  EP
                </div>
                <div>
                  <p className="text-sm font-semibold text-white">Essex PlumbPro</p>
                  ...
                  >
                    <div
                      className={`max-w-[85%] rounded-2xl px-4 py-2.5 ${
                        msg.from === "customer"
                          ? "rounded-br-md bg-electric-500 text-white"
